...
from books.views import MainPage, ContactView, HomeView, RecommendationView, CatalogView, AddRecommendationView, AddUserView, LogoutView, LoginView, UserListView, TopTenView
